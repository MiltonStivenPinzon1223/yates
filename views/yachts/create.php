...
?>
  ...
  <div class="mb-3 mt-3">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" placeholder="Precio del yate" name="price">
      <span class="input-group-text">.000</span>
    </div>
  </div>
  <div class="mb-3 mt-3">
    <label for="information" class="form-label">informacion:</label>
    <input type="text" class="form-control" id="information" placeholder="Enter information" name="information">
  </div>
  <div class="mb-3 mt-3">
    <label for="serie" class="form-label">serie:</label>
    <input type="text" class="form-control" id="serie" placeholder="Enter serie" name="serie">
  </div>
