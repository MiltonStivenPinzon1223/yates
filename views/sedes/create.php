...
<div class="card bg-light">
      ...
      <form action="./store" method="POST">
        <div class="mb-3 mt-3">
          ...
          <input type="text" class="form-control" id="name" placeholder="Inserte nombre" name="sede">
        </div>
        <div class="mb-3">
          <label for="direction" class="form-label">Direccion:</label>
          <input type="text" class="form-control" id="direction" placeholder="Inserte direccion" name="direction">
        </div>
