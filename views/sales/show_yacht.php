          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item <?php if ($url == "/quotes") {echo "active";} ?>">
                <a class="nav-link text-dark" href="quotes">Quotes</a>
              </li>
    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-7 col-sm-12">
              <img class="card-img-top" src="./<?php echo $product['photo']; ?>" alt="Title">
            </div>
            <div class="col-md-5 col-sm-12">
            <div class="card text-dark bg-light">
              <div class="card-body">
                <h3 class="card-title"><?php echo $product['model']; ?></h3>
                <p class="card-text">$ <?php echo $product['price']; ?>.000</p>
                <p class="card-text"><?php echo $product['serie']; ?></p>
