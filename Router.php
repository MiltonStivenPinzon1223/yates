...
class Router{
    ...
    function matchRoute(){
        $routes = [
            ...
            ['/administraitor/yachts/show', 'YachtController', 'show'],
            ['/administraitor/yachts/create', 'YachtController', 'create'],
            ['/administraitor/yachts/store', 'YachtController', 'store'],
            ['/administraitor/yachts/edit', 'YachtController', 'edit'],
            ['/administraitor/yachts/update', 'YachtController', 'update'],
            ['/administraitor/yachts/delete', 'YachtController', 'delete'],
            ...
            ['/quotes/create', 'QuoteController', 'create'],
            ['/quotes/store', 'QuoteController', 'store'],
            ['/quotes/edit', 'QuoteController', 'edit'],
            ['/quotes/update', 'QuoteController', 'update'],
